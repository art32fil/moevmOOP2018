...
battlefield::battlefield()
{
	...
	const shared_ptr<int> crown1(new int(1));
	const shared_ptr<int> crown2(new int(2));
...
void battlefield::new_team(List<Object*> *new_team,ifstream& fin,const shared_ptr<int> t) {
	int size;
	fin >> size;
