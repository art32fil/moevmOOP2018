...
public:
    ...
    Object(Object&& obj) : coords(std::move(obj.get_coords())),
                hit_points(std::move(obj.get_hp())), position(std::move(obj.get_pos())) {
                            std::cout << "\tx = " << coords.axis_x << std::endl
                                      << "\ty = " << coords.axis_y << std::endl
                                      << "\thp = " << hit_points << std::endl
    ...
    size_t            &get_pos()                { return position; }
    const size_t      &get_pos() const          { return position; }
